...
export const EditDataUser = ({ usuario, index }) => {
    ...
    const handleSubmit = (e) => {
        ...
        try {
            const res =  fetch(URL_EDITAR_USER+idUser, option),
            json =  res.json();
            if (!res.ok) {
                console.log(json);
                return swal({
        ...
        <Form className="container-fluid register-content" >
                ...
                <div className="row justify-content-center">
                    <div className="col-md-12 mt-3">
                        ...
                        <Form.Select aria-label="Tipo" value={roleActual} onChange={(e) => setRoleActual(e.target.value)} >
                    ...
                    <div className="col-md-12 mt.3">
					    ...
					    <button onClick={handleSubmit}>actualizar usuario</button>
                    </div>
                </div>
